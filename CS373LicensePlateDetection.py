...
def main():
    ...
    contrast_array = computeStandardDeviationImage5x5(pixel_array=greyscale_array, image_width=image_width, image_height=image_height)

    # Thresholding for Segmentation
    binary_image_array = thresholdBinaryImage(pixel_array=contrast_array, image_width=image_width, image_height=image_height)
